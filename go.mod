module github.com/middleware-labs/datadoglogreceiver

go 1.20

require (
	github.com/middleware-labs/datadoglogreceiver/internal/sharedcomponent v0.0.0-20240501151420-3aa72ff8b634
